...
public interface BaseDao<T extends AbstractEntity> {
	 ...
	 * @param id
	 *            The entity id.
	 * @return The entity with the specified id or null if no such entity
	 *         exists.
	 */
	T findById(Long id);

	/**
	 * Retrieves the entity of type clazz and the given natural id.
	 *
	 * @param naturalId
	 *            The entity natural Id.
	 * @return The entity with the specified natural id or null if no such
	 *         entity exists.
	 */
